...
public class VerbosTest {
    ...
    public void deveSalvarUsuarioViaXML(){
        given()
                ...
                .body("<user><name>Gabriel Salazar</name><age>30</age></user>")
                .when()
                ...
                .body("user.name", is("Gabriel Salazar"))
                .body("user.age",is("30"));
    }
/*
    @Test
...
//<user><name>Gabriel Salazar</name><age>30</age></user>
